  ...
  return (
    <group {...props} dispose={null}>
      <group position={[-0.01, 0.04, -0.01]} rotation={[-Math.PI / 2, 0, 0]}>
        <group scale={0.1}>
          <mesh geometry={nodes.Body1.geometry} material={materials['Clean Gold']} scale={500} />
          <mesh geometry={nodes.Body2.geometry} material={materials['Silver Glossy']} scale={500} />
          <mesh geometry={nodes.Body1_2.geometry} material={materials['Gelatin 2']} scale={500} />
        </group>
      </group>
