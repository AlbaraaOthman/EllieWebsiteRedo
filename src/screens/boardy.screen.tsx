    ...
    <>
      <div className={"w-screen h-screen grid grid-cols-12 grid-rows-9 gap-5 bg-darkback z-0"}>
        ...
        <div className={`col-start-7 col-end-11 col-span-2 row-start-2 w-auto h-auto text-lightback z-20 font-neue `} style={{ fontSize: textSize , lineHeight: textSpace}}>
          <>
            <span className="opacity-50 text-head font-neues " style={{ fontSize: titleSize , lineHeight: titlSpace}}>How to Model a Brand</span>
            <div className='h-[20px]'></div>
            <Collapsible className="z-10" id="1" transitionTime={500} trigger="&nbsp; 1. Set clear goals." open={"1" === open} onOpening={() => setNumber(1)} onClosing={() => setNumber(0)} triggerOpenedClassName='text-redish  font-neues' triggerClassName='font-neues ' triggerStyle={{fontSize: headingSize, lineHeight: headSpace}}    >
              <div className='ml-4'>
            ...
            <Collapsible className="z-10" id="2" transitionTime={500} trigger="&nbsp; 2. Curate the brand." open={"2" === open} onOpening={() => setNumber(2)} onClosing={() => setNumber(0)} triggerOpenedClassName='text-redish  font-neues' triggerClassName='font-neues ' triggerStyle={{fontSize: headingSize, lineHeight: headSpace}}   >
              <div className='ml-4'>
            ...
            <Collapsible className="z-10" id="3" transitionTime={500} trigger="&nbsp;  3. Assign a uniform." open={open === "3"} onOpening={() => setNumber(3)} onClosing={() => setNumber(0)} triggerOpenedClassName='text-redish  font-neues' triggerClassName='font-neues ' triggerStyle={{fontSize: headingSize, lineHeight: headSpace}}   >
              <div className='ml-4'>
            ...
            <Collapsible className="z-10" id="4" transitionTime={500} trigger="&nbsp;  4. Be the most excited." open={open === "4"} onOpening={() => setNumber(4)} onClosing={() => setNumber(0)} triggerOpenedClassName='text-redish  font-neues' triggerClassName='font-neues ' triggerStyle={{fontSize: headingSize, lineHeight: headSpace}}   >
              <div className='ml-4'>
            ...
            <Collapsible className="z-10" id="5" transitionTime={500} trigger="&nbsp;  5. Ask for feedback." open={open === "5"} onOpening={() => setNumber(5)} onClosing={() => setNumber(0)} triggerOpenedClassName='text-redish  font-neues' triggerClassName='font-neues ' triggerStyle={{fontSize: headingSize, lineHeight: headSpace}}   >
              <div className='ml-4'>
