...
import Logo from  '../components/Commad';
import DrawingArea from '../components/DrawingAreaBack';
import { Euler } from 'three';
type commaScreenProp = StackNavigationProp<RootStackParamList, 'Logo'>;

function CommaScreen() {
  const navigation = useNavigation<commaScreenProp>();
